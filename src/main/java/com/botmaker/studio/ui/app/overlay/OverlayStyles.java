...
public final class OverlayStyles {
     ...
     * An overlay stage builds its own {@link javafx.scene.Scene}, so it does not inherit the main window's.
     */
    public static void applyThemeClass(Parent node) {
        node.getStyleClass().add(switch (BlockTheme.getCurrentThemeType()) {

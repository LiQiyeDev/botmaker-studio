...
import com.botmaker.ui.render.components.PlaceholderComponents;
...
public abstract class AbstractStatementBlock extends AbstractCodeBlock implements StatementBlock {
    ...
    protected javafx.scene.layout.VBox createIndentedBody(com.botmaker.core.BodyBlock body, CodeEditorService context, String styleClass) {
        Node bodyNode = (body != null) ? body.getUINode(context) : null;
        return LayoutComponents.createIndentedBody(bodyNode, styleClass);
    }

    protected Node getOrDropZone(com.botmaker.core.ExpressionBlock expr, CodeEditorService context) {

package com.botmaker.suggestions;

import com.botmaker.index.TypeSummaryManager;
import com.botmaker.parser.helpers.FileTypeDetector;
...
public class ProjectAnalyzer {
     ...
     */
    public List<com.botmaker.project.activity.ActivityVariable> getActivityVariables(ResolvedType requiredType) {
